...
export default function Home() {
  ...
  const backgroundImage =
    'https://5.imimg.com/data5/SELLER/Default/2025/8/541064117/IN/EO/WL/2188906/office-interior-designing-service.jpg';
    ...
    <div className="min-h-screen bg-background">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center gap-8">
            ...
            <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.97 }}>
              <Button className="bg-primary text-primary-foreground hover:bg-primary/90 transition-transform duration-300">
                Get Started
              </Button>
            </motion.div>
          </div>
      ...
      `}
            style={{
              ...
              animation:
                index === currentSlide ? 'kenburns 12s ease-out forwards' : 'none',
            }}
          >
        ...
        >
          ...
          >
            Expert chartered accountants dedicated to optimizing your business finances,
            minimizing tax liability, and driving sustainable growth.
          </motion.p>
          ...
          <div className="grid md:grid-cols-3 gap-10">
            ...
            >
              ...
              <div className="relative z-10 hover:text-white">
                ...
                <h3 className="text-xl font-bold e mb-3">Financial Planning</h3>
                <p className=" mb-5">
                  Strategic budgeting, forecasting, and financial analysis for smarter
                  growth.
                </p>
            ...
            >
              ...
              <div className="relative z-10 hover:text-white">
                ...
                <h3 className="text-xl font-bold  mb-3">Business Advisory</h3>
                <p className=" mb-5">
      ...
      <section className="py-14 bg-secondary/30 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          >
            ...
            <p
              className="max-w-5xl mx-auto text-muted-foreground animate-fade-in-up"
              style={{ animationDelay: '0.1s' }}
            >
              A complete service stack — from strategy to execution — so you work with
              one dependable partner for your financial journey.
            </p>
          </motion.div>
          ...
          <div className="space-y-6">
            {[
              ...
              return (
                <motion.div
                  key={idx}
                  className={`animate-fade-in-up flex flex-col  gap-2 md:gap-6 md:items-center ${
                    reversed ? 'md:flex-row-reverse text-right' : 'md:flex-row '
                  }`}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p
              ...
              style={{ animationDelay: '0.1s' }}
            >
              See how we&apos;ve transformed businesses through strategic financial
              planning
            </p>
          </motion.div>
            ...
            <div className="space-y-10 md:space-y-16">
              {[
                ...
                return (
                  <motion.div
                    key={idx}
                    className={`relative flex flex-col md:flex-row items-start md:items-center gap-4 md:gap-10 animate-fade-in-up ${
      ...
      <section
        className="relative  overflow-hidden py-10 text-primary-foreground"
        style={{
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-lg text-muted-foreground max-w-3xl mx-auto">
              Deep, hands-on experience across sectors where regulation, risk and growth
              intersect.
            </p>
          </motion.div>
            ...
            >
              ...
              <div className="relative ">
                ...
                <p className="text-sm sm:text-base text-muted-foreground mb-5 leading-relaxed">
                  Each sector comes with its own mix of regulations, reporting standards,
                  funding patterns, and risk triggers. Our team brings sector-specific
                  playbooks plus the ability to connect numbers with real-world
                  operations.
                </p>
                ...
                <ul className="space-y-3 text-sm text-muted-foreground">
                  ...
                  <li className="flex items-start gap-2.5">
                    ...
                    <span>
                      Playbooks for VC-backed, family-owned, and professionally managed
                      businesses.
                    </span>
                  </li>
                  <li className="flex items-start gap-2.5">
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <p className="text-muted-foreground mb-4 leading-relaxed">
                With over two decades of experience, our team of qualified chartered
                accountants brings expertise across diverse industries and business
                models.
              </p>
      ...
      {/* Our Process – Timeline Section with animation */}
      <motion.section
          ...
          <div className="flex flex-col lg:flex-row lg:items-end lg:justify-between gap-6 mb-10">
            <div>
              ...
              <p className="mt-2 text-sm sm:text-base text-muted-foreground max-w-xl">
                Real feedback from founders and teams who use our services to bring
                clarity, control, and confidence to their numbers.
              </p>
            </div>
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center mb-10">
            ...
            <p className="mt-2 text-sm sm:text-base text-muted-foreground max-w-2xl mx-auto">
              Quick answers to the most common questions founders and finance teams ask

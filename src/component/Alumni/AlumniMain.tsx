        ...
        <div className="bg-[#F7F9F8] text-[#1C1C1C]">
            ...
            <section className="relative h-150 bg-[#000000]/70 py-15 text-white overflow-hidden">
                ...
                <div className="relative max-w-7xl mx-auto px-6 pt-52 text-center">
                    <h1 className="text-4xl md:text-5xl drop-shadow-[0_2px_0px_rgba(0,0,0,0.8)] font-bold mb-6">
            ...
            <section className="max-w-7xl mx-auto px-6 py-10 text-center">
                <h2 className="text-5xl font-bold drop-shadow-[0_2px_0px_rgba(0,0,0,0.8)] text-[#0F3D2E] mb-6">
            ...
            <section className="max-w-7xl mx-auto px-6 py-6 grid md:grid-cols-2 gap-5 ">
                ...
                <div className=" pt-20">
                    <h3 className="text-5xl drop-shadow-[0_2px_0px_rgba(0,0,0,0.8)] font-bold text-[#0F3D2E] mb-4">
            ...
            <section className="max-w-7xl mx-auto px-6 py-16">
                <h3 className="text-5xl drop-shadow-[0_2px_0px_rgba(0,0,0,0.8)] font-bold pb-5 text-center  text-[#0F3D2E] mb-10">
                    Alumni Moments
                </h3>
